...
`}</style>
      ...
      <div className="mobile-menu-overlay" style={{
        ...
        display: 'none'
          ...
          <Link href="/blog" onClick={() => setMenuOpen(false)} style={{ fontSize: '24px', color: '#2c3e50', textDecoration: 'none', fontWeight: '500' }}>Blog</Link>
        ...
        >
          ...
          <div className="responsive-col" style={{ flex: '1 1 500px' }}>
            <h2 className="responsive-title"
              ...
              >
                Terapia Para <span style={{ color: '#4a90e2', fontStyle: 'italic' }}>Jovenes</span>  <br/>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                Dirigida a jóvenes que necesitan comprender lo que sienten, construir autonomía emocional o atravesar transiciones significativas.
Aborda temas como ansiedad, tristeza, confusión vital, dificultades relacionales, autoconcepto, problemas escolares, impulsividad y conflictos familiares.            
                </p>
                <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.8', fontFamily: '"Poppins", sans-serif' }}>
                Busca acompañar la construcción de identidad, fortalecer recursos internos y ofrecer una escucha honesta donde puedan pensar su historia, sus emociones y sus decisiones. El acompañamiento se realiza desde el vínculo terapéutico, el respeto y la confidencialidad.
                </p>
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: '18px', color: '#2c3e50', lineHeight: '1.6', margin: 0, fontStyle: 'italic', fontWeight: '500' }}>
                      "Un lugar seguro para explorar la identidad, los vínculos y la emocionalidad propia de esta etapa vital."
                    </p>
                </div>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <PreguntasFrecuentes categoria="terapia-jovenes" />
            </div>
