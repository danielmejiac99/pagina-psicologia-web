  ...
  />
      ...
      <section style={{
        ...
        <div style={{
          ...
          flexDirection: 'row-reverse' // ← texto a la derecha, imágenes a la izquierda
        }}>
          {/* Columna texto (se verá a la derecha) */}
          <div style={{ flex: '1 1 360px', minWidth: '280px' }}>
            ...
            <h2 style={{
              ...
              Especialista en Clínica Psicoanalítica
            </h2>
            <h2 style={{
              fontSize: '18px',
              fontWeight: '500',
            ...
            <p style={{
              ...
              Mi trabajo se sostiene en una escucha profunda que reconoce la singularidad de cada historia. Desde el psicoanálisis, acompaño a quienes buscan comprenderse, aliviar su sufrimiento o transformar sus vínculos, ofreciendo una mirada sensible a aquello que a veces cuesta nombrar.
            </p>
            ...
            <p style={{
              ...
              Cuento con más de siete años de experiencia en el acompañamiento de niños, adolescentes, adultos y parejas, así como en procesos relacionados con adicciones y dificultades emocionales complejas. Cada encuentro terapéutico me recuerda la importancia de un espacio seguro donde las emociones puedan desplegarse con respeto y humanidad.
            </p>
            ...
            <p style={{
              ...
              Acompaño procesos vinculados a la salud mental, las relaciones, el desarrollo personal, la regulación emocional y los momentos de crisis o búsqueda de sentido. Me inspira escuchar lo que emerge en la palabra, acompañar sin prisa y ofrecer una presencia que sostenga y permita abrir nuevos caminos.
            </p>
            ...
            <p style={{
              ...
              Creo en una terapia cercana, ética y profundamente humana, donde cada consultante encuentre un lugar para pensarse, reconstruirse y avanzar hacia una vida más habitable. Mi propósito es brindar un acompañamiento respetuoso, claro y profesional que honre la historia y el proceso de cada persona.
            </p>
            ...
            <Link href="/contacto">
              ...
              >
                Agenda una consulta con Leidy
              </button>
            </Link>
          </div>

          {/* Columna imágenes (se verá a la izquierda) */}
          <div
