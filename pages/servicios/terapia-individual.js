...
`}</style>
      ...
      <HeroHeader image="/imagen3.png" height="100vh" />
            ...
            {/* Sección Terapia Individual por Ciclo Vital - REDISEÑO */}
          ...
          <div className="responsive-col" style={{ flex: '1 1 500px' }}>
            <h2 className="responsive-title"
              ...
              >
                ...
                <span style={{ color: '#4a90e2', fontStyle: 'italic' }}>por Ciclo Vital</span>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.8', fontFamily: '"Poppins", sans-serif' }}>
                  Esta modalidad está dirigida a quienes buscan un espacio íntimo para trabajar su bienestar emocional, tomar decisiones, comprender lo que sienten o atravesar momentos significativos de su vida. <strong>Se adapta a las necesidades de cada etapa vital: infancias, juventudes y adultez.</strong>
                </p>
                <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.8', fontFamily: '"Poppins", sans-serif' }}>
                  Aborda situaciones como estrés, angustia, cambios vitales, conflictos personales, dificultades emocionales, problemas de identidad, desregulación emocional, dinámicas familiares complejas o procesos de crecimiento personal.
                </p>
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: '18px', color: '#2c3e50', lineHeight: '1.6', margin: 0, fontStyle: 'italic', fontWeight: '500' }}>
                      "Su propósito es ayudar a cada persona a construir herramientas internas, fortalecer su estabilidad emocional y descubrir formas más amables y conscientes de habitar su vida."
                    </p>
                </div>
            </div>
          </div>
          ...
          >
            ...
            >
              <p style={{ 
                ...
                Procesos integrales para reconectar con tu equilibrio físico, emocional y mental. <strong>Dirigido a personas que desean trabajar su bienestar de manera global, integrando aspectos psicológicos, emocionales, físicos y relacionales.</strong>
              </p>
            </div>
            ...
            {/* Quote destacada */}
            <div style={{
                background: 'linear-gradient(135deg, rgba(74, 144, 226, 0.1), rgba(255, 105, 180, 0.08))',
                padding: '35px 40px',
                borderRadius: '24px',
            ...
            >
              <p style={{ 
                ...
                " Es un acompañamiento que integra reflexión, hábitos, cuidado emocional y trabajo interno para lograr un equilibrio sostenible."
              </p>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <PreguntasFrecuentes categoria="terapia-individual" />
            </div>
