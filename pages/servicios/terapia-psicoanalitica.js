...
`}</style>
        ...
        >
          ...
          <div className="responsive-col" style={{ flex: '1 1 500px' }}>
            <h2 className="responsive-title"
              ...
              >
                Terapia <span style={{ color: '#4a90e2', fontStyle: 'italic' }}>Psicoanalítica</span>  <br/>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                La terapia psicoanalítica está dirigida a personas que desean comprender a fondo lo que sienten, lo que les pasa y por qué ciertos patrones se repiten en su vida. Es un espacio para quienes buscan explorar su mundo interno, su historia y las experiencias que han marcado su forma de habitar el presente.
                </p>
                <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.8', fontFamily: '"Poppins", sans-serif' }}>
                Este servicio aborda situaciones como malestar emocional, ansiedad, tristeza, conflictos relacionales, crisis personales, dudas existenciales, baja autoestima, dificultades vinculares y procesos de autoconocimiento.
                </p>
                <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.8', fontFamily: '"Poppins", sans-serif' }}>
                Se busca acompañar la construcción de sentido, la transformación de patrones internos y la comprensión profunda de aquello que a veces cuesta nombrar. La terapia ofrece una escucha atenta, ética y respetuosa, donde la palabra encuentra un lugar para desplegarse y donde cada persona puede descubrir nuevas formas de comprenderse y relacionarse consigo misma y con los demás.
                </p>
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: '18px', color: '#2c3e50', lineHeight: '1.6', margin: 0, fontStyle: 'italic', fontWeight: '500' }}>
                      "Este es un espacio profundo para explorar tu historia, tus emociones y tus vínculos."
                    </p>
                </div>
            </div>
          </div>
      ...
      {/* ✅✅✅ CONTENEDOR SPLIT: EDUCACIÓN EMOCIONAL (Izquierda) + DUELO (Derecha) ✅✅✅ */}
      <div className="split-container" style={{
        ...
        {/* --- Bloque Izquierdo: Educación Emocional --- */}
        <section className="responsive-section"
            style={{
            flex: 1, // 50% del ancho
            padding: '50px 40px',
        ...
        >
            <div style={{ maxWidth: '650px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Este servicio está dirigido a <strong>niños, adolescentes y adultos </strong> que desean fortalecer su inteligencia emocional, comprender cómo funcionan sus emociones y desarrollar habilidades para gestionar lo que sienten en la vida cotidiana.
                    </p>
                    </div>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Aborda dificultades en la regulación emocional, impulsividad, frustración, baja tolerancia, problemas de comunicación, ansiedad, conflictos interpersonales y habilidades sociales limitadas.
                    </p>
                    </div>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Busca potenciar la autonomía emocional, mejorar las relaciones y promover formas más saludables de expresar, contener y transformar lo que se siente. El acompañamiento combina escucha clínica con recursos pedagógicos y creativos.
                    </p>
                    </div>
                </div>
            </div>
        ...
        {/* --- Bloque Derecho: Duelo y Enfermedad --- */}
        <section className="responsive-section"
            style={{
            flex: 1, // 50% del ancho
            padding: '50px 40px',
            background: 'linear-gradient(135deg, #f0f7ff 0%, #f8f9ff 50%, #fdf6f8 100%)',
            position: 'relative'
            }}
        >
            <div style={{ maxWidth: '650px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                ...
                >
                    ...
                    <div style={{
                        ...
                        width: '150px',
                        height: '5px',
                        background: 'linear-gradient(to right, #4a90e2 0%, transparent 70%)',
                        marginTop: '15px',
                        borderRadius: '3px'
                    }}></div>
                </h2>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Dirigido a <strong>personas </strong> que desean trabajar su bienestar de manera global, integrando aspectos psicológicos, emocionales, físicos y relacionales.
                    </p>
                    </div>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Aborda estados de agotamiento, estrés prolongado, desconexión personal, alteraciones del sueño, desgaste emocional, dificultades para establecer hábitos saludables y sensación de vacío o falta de propósito.
                    </p>
                    </div>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Se busca acompañar a la persona en la reconstrucción de su equilibrio interno, fortaleciendo la relación consigo misma y promoviendo un bienestar más estable y consciente. Es un acompañamiento que integra reflexión, hábitos, cuidado emocional y trabajo interno.
                    </p>
                    </div>
                </div>
            </div>
            
            {/* Botón CTA dentro de este bloque */}
            <div style={{ marginTop: '40px', textAlign: 'center' }}>
                ...
                <button
                    ...
                    onMouseEnter={(e) => {
                        ...
                        e.target.style.boxShadow = '0 12px 25px rgba(255, 105, 180, 0.4)';
                    }}
                    onMouseLeave={(e) => {
                        e.target.style.transform = 'translateY(0)';
                        e.target.style.boxShadow = '0 8px 20px rgba(255, 105, 180, 0.3)';
                    }}
                >
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <PreguntasFrecuentes categoria="terapia-psicoanalitica" />
            </div>
