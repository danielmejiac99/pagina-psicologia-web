        ...
        >
          ...
          <div className="responsive-col" style={{ flex: '1 1 500px' }}>
            <h2 className="responsive-title"
              ...
              >
                Terapia Para <span style={{ color: '#4a90e2', fontStyle: 'italic' }}>Adultos</span>  <br/>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                Dirigida a personas que buscan entender su malestar, afrontar cambios vitales, mejorar sus vínculos o profundizar en su mundo interno.
Aborda ansiedad, depresión, duelos, rupturas, estrés, crisis existenciales, patrones repetitivos, autocuidado, agotamiento, autoestima y dificultades en la vida afectiva.

                </p>
                <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.8', fontFamily: '"Poppins", sans-serif' }}>
                El propósito es acompañar procesos de autoconocimiento, regulación emocional, elaboración de experiencias y resignificación de la historia personal. Se ofrece una escucha profunda, ética y respetuosa del ritmo de cada consultante.
                </p>
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: '18px', color: '#2c3e50', lineHeight: '1.6', margin: 0, fontStyle: 'italic', fontWeight: '500' }}>
                      "Un refugio íntimo para comprenderte, transformarte y encontrar maneras más amables de habitar tu vida."
                    </p>
                </div>
            </div>
          </div>
        ...
        >
            <div style={{ maxWidth: '650px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Dirigido a <strong>personas y familias </strong> que atraviesan procesos de duelo, pérdidas significativas, diagnósticos médicos, tratamientos prolongados o situaciones que confrontan con la vulnerabilidad de la vida.
                    </p>
                    </div>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Aborda el dolor emocional, la tristeza profunda, la incertidumbre, el miedo, la desorientación o la necesidad de reorganizar la vida frente a un cambio drástico.
                    </p>
                    </div>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Su propósito es ofrecer sostén emocional, acompañar el proceso de adaptación, permitir expresar lo que duele y ayudar a resignificar la experiencia desde un lugar más humano y compasivo. El acompañamiento invita a transitar el dolor sin prisa y a recuperar gradualmente la posibilidad de seguir adelante.
                    </p>
                    </div>
                </div>
            </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <PreguntasFrecuentes categoria="terapia-adultos" />
            </div>
