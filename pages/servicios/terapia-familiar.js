        ...
        >
          ...
          <div className="responsive-col" style={{ flex: '1 1 500px' }}>
            <h2 className="responsive-title"
              ...
              >
                Terapia<span style={{ color: '#4a90e2', fontStyle: 'italic' }}>Familiar</span>  <br/>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                Dirigida a familias que atraviesan tensiones, cambios importantes o dificultades para comprenderse entre sí. Aborda conflictos parentales, crianza, límites, roles, comunicación, transiciones vitales (separación, mudanzas, duelos), relación entre hermanos y comportamientos que expresan malestar en algún miembro del sistema.
                </p>
                <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.8', fontFamily: '"Poppins", sans-serif' }}>
                Busca generar conversaciones que permitan resignificar la historia familiar, comprender las necesidades de cada integrante y crear formas más sanas de relación. Ofrece una guía respetuosa que acompaña a la familia en su proceso de reorganización emocional.
                </p>
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: '18px', color: '#2c3e50', lineHeight: '1.6', margin: 0, fontStyle: 'italic', fontWeight: '500' }}>
                      "Un espacio para reconstruir la comunicación, comprender la dinámica familiar y fortalecer los vínculos."
                    </p>
                </div>
            </div>
          </div>
        ...
        >
            <div style={{ maxWidth: '650px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Busca generar conversaciones que permitan comprender lo que ocurre en el sistema familiar, resignificar roles y fortalecer los lazos afectivos. El acompañamiento ofrece un espacio seguro para escucharse, crear acuerdos y construir formas más conscientes y respetuosas de relacionarse como familia.                    </p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <PreguntasFrecuentes categoria="terapia-familiar" />
            </div>
