        ...
        >
          ...
          <div className="responsive-col" style={{ flex: '1 1 500px' }}>
            <h2 className="responsive-title"
              ...
              >
                Talleres grupales y <span style={{ color: '#4a90e2', fontStyle: 'italic' }}>Acompañamiento Psicoeducativo</span>  <br/>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                Dirigido a grupos, instituciones, equipos educativos, empresas y comunidades que buscan fortalecer el bienestar emocional, la convivencia y los recursos psicosociales.
                </p>
                <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.8', fontFamily: '"Poppins", sans-serif' }}>
                Aborda temas como manejo emocional, comunicación asertiva, liderazgo, trabajo en equipo, prevención del estrés, autocuidado, vínculos sanos, crianza, acompañamiento escolar y fortalecimiento de redes de apoyo.
                </p>
                <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.8', fontFamily: '"Poppins", sans-serif' }}>
                Su propósito es ofrecer herramientas prácticas, comprensión emocional y espacios seguros donde el aprendizaje se construya a partir de la experiencia compartida. El acompañamiento integra metodologías reflexivas, creativas, arteterapéuticas y psicoeducativas, adaptadas a las necesidades de cada grupo o institución.
                </p>
                <div style={{
                    ...
                    <p style={{ fontSize: '18px', color: '#2c3e50', lineHeight: '1.6', margin: 0, fontStyle: 'italic', fontWeight: '500' }}>
                      "Procesos colectivos para aprender, reflexionar y crear bienestar en comunidad."
                    </p>
                </div>
            </div>
          </div>
            ...
            <div style={{ maxWidth: '650px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.7', margin: 0, fontFamily: '"Poppins", sans-serif', fontWeight: '400' }}>
                        Este servicio está dirigido a <strong> adultos </strong> que desean fortalecer su inteligencia emocional, comprender cómo funcionan sus emociones y desarrollar habilidades para gestionar lo que sienten en la vida cotidiana.
                    </p>
                    </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <PreguntasFrecuentes categoria="terapia-grupales" />
            </div>
