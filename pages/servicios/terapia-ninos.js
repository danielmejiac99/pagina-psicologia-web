        ...
        >
          ...
          <div className="responsive-col" style={{ flex: '1 1 500px' }}>
            <h2 className="responsive-title"
              ...
              >
                Terapia Para <span style={{ color: '#4a90e2', fontStyle: 'italic' }}>Niños</span>  <br/>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                Dirigida a niñas y niños que atraviesan cambios, dificultades emocionales o comportamientos que expresan aquello que aún no logran poner en palabras.
                Acompaña situaciones como miedos, frustración, impulsividad, dificultades escolares, cambios familiares, baja autoestima y procesos de desarrollo emocional.
            
                </p>
                <p style={{ fontSize: '18px', color: '#4a5568', lineHeight: '1.8', fontFamily: '"Poppins", sans-serif' }}>
                 El objetivo es ayudarles a reconocer, expresar y regular sus emociones, comprender lo que viven y fortalecer su capacidad de adaptación. El acompañamiento integra juego terapéutico, arteterapia y trabajo con cuidadores para crear un entorno que sostenga su crecimiento.
                </p>
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: '18px', color: '#2c3e50', lineHeight: '1.6', margin: 0, fontStyle: 'italic', fontWeight: '500' }}>
                      "Un espacio donde el juego, el arte y la imaginación se convierten en lenguaje emocional."
                    </p>
                </div>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <PreguntasFrecuentes categoria="terapia-niños" />
            </div>
